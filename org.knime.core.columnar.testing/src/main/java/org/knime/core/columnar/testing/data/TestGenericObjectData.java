...
public final class TestGenericObjectData extends TestData
    ...
    static final class TestGenericObjectDataFactory implements TestDataFactory {
        ...
        @Override
        public TestGenericObjectData createWriteData(final int capacity) {
            return new TestGenericObjectData(capacity);
        }

        @Override
        public TestGenericObjectData createReadData(final Object data) {
            return new TestGenericObjectData((Object[])data);
        }

    }

    TestGenericObjectData(final int capacity) {
        super(new Object[capacity]);
    }

    TestGenericObjectData(final Object[] objects) {
        super(objects);
        close(objects.length);
    }

    @Override
    public TestGenericObjectData close(final int length) {
    ...
    @Override
    public synchronized void setObject(final int index, final Object val) {
        get()[index] = val;
    }
