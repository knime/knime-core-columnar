 ...
 * @since 4.3
 */
final class ColumnarIntValueFactory implements ColumnarValueFactory<IntReadData, //
        IntReadAccess, IntWriteData, IntWriteAccess> {

    /** INSTANCE **/
    public final static ColumnarIntValueFactory INSTANCE = new ColumnarIntValueFactory();

    private ColumnarIntValueFactory() {
    }
