 ...
 * @since 4.3
 */
final class ColumnarDoubleValueFactory
    implements ColumnarValueFactory<DoubleReadData, DoubleReadAccess, DoubleWriteData, DoubleWriteAccess> {

    /** Instance **/
    public static final ColumnarDoubleValueFactory INSTANCE = new ColumnarDoubleValueFactory();

    private ColumnarDoubleValueFactory() {
    }
