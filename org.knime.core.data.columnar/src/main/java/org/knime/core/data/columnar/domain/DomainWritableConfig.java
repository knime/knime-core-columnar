...
/**
 * Config object for a {@link DomainWritable}.
 *
...
public interface DomainWritableConfig {
     ...
     */
    DomainWritableConfig withMaxPossibleNominalDomainValues(int maxPossibleValues);
     ...
     */
    Map<Integer, ColumnarDomainCalculator<? extends NullableReadData, DataColumnMetaData[]>> // NOSONAR
