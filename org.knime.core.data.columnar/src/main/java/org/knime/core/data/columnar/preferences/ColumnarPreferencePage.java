...
public final class ColumnarPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    private final int m_offHeapMemoryLimit;

    private IntegerFieldEditor m_offHeapMemoryLimitEditor;
    ...
    public ColumnarPreferencePage() {
        super(GRID);
        m_offHeapMemoryLimit = ColumnarPreferenceUtils.getOffHeapMemoryLimitMB();
    }
    ...
    protected void createFieldEditors() {
        ...
        m_offHeapMemoryLimitEditor =
            new IntegerFieldEditor(OFF_HEAP_MEM_LIMIT_KEY, "Off-Heap Memory Limit (in MB)", parent);
        m_offHeapMemoryLimitEditor.setValidRange(1024, Integer.MAX_VALUE);
        addField(m_offHeapMemoryLimitEditor);
    }
    ...
    private void checkChanges() {
        ...
        if (m_offHeapMemoryLimit != ColumnarPreferenceUtils.getOffHeapMemoryLimit()) {
            Display.getDefault()
