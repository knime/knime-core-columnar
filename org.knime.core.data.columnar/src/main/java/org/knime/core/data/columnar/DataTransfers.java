...
final class DataTransfers {
    ...
    static DataTransfer[] createTransfers(final ColumnarSchema schema) {
        return schema.specStream()//
            .map(DataTransfers::createTransfer)//
            .toArray(DataTransfer[]::new);
    }

    static DataTransfer createTransfer(final DataSpec dataSpec) {
    ...
    private enum DataSpecToTransferMapper implements DataSpec.Mapper<DataTransfer> {
        ...
        public DataTransfer visit(final ByteDataSpec spec) {
            throw new NotImplementedException("byte transfer isn't implemented");
        }
        ...
        public DataTransfer visit(final FloatDataSpec spec) {
            throw new NotImplementedException("float transfer isn't implemented");
        }
        ...
        public DataTransfer visit(final LongDataSpec spec) {
            throw new NotImplementedException("long transfer isn't implemented");
        }

        @Override
        public DataTransfer visit(final VarBinaryDataSpec spec) {
            throw new NotImplementedException("varbinary transfer isn't implemented");
        }

        @Override
        public DataTransfer visit(final VoidDataSpec spec) {
            throw new NotImplementedException("void transfer isn't implemented");
        }

        @Override
        public DataTransfer visit(final StructDataSpec spec) {
            throw new NotImplementedException("struct transfer isn't implemented");
        }

        @Override
        public DataTransfer visit(final ListDataSpec listDataSpec) {
            throw new NotImplementedException("list transfer isn't implemented");
        }
