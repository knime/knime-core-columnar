 ...
 */
public final class ColumnarBatchStore implements BatchStore, Flushable {
    /**
    ...
    public static final class ColumnarBatchStoreBuilder {
         ...
         */
        public ColumnarBatchStoreBuilder(final BatchWritable writable, final RandomAccessBatchReadable readable) {
         ...
         */
        public <D extends BatchWritable & RandomAccessBatchReadable> ColumnarBatchStoreBuilder(final D delegate) {
        ...
        /**
         * Build a {@link ColumnarBatchStore} with the given configuration
         *
         * @return A new {@link ColumnarBatchStore}
         */
        public ColumnarBatchStore build() {
            return new ColumnarBatchStore(this);
        }
    }
    ...
    private ColumnarBatchStore(final ColumnarBatchStoreBuilder builder) {
