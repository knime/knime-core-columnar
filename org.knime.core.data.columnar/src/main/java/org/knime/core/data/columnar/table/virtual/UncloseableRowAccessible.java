...
/**
 * A decorator for {@link RowAccessible} that prevents closing the decorated RowAccessible while delegating all other
 * methods. This is useful for controlling the life-cycle of the decorated RandomAccessible.
 *
 * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
 */
final class UncloseableRowAccessible implements RowAccessible {

    private final RowAccessible m_delegate;

    UncloseableRowAccessible(final RowAccessible delegate) {
        m_delegate = delegate;
    }
