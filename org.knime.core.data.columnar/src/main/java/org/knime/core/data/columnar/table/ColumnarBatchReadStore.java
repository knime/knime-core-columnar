 ...
 */
public final class ColumnarBatchReadStore implements BatchReadStore {
    /**
    ...
    public static final class ColumnarBatchReadStoreBuilder {
        ...
        /**
         * Build a {@link ColumnarBatchReadStore} with the given configuration
         *
         * @return A new {@link ColumnarBatchReadStore}
         */
        public ColumnarBatchReadStore build() {
            return new ColumnarBatchReadStore(this);
        }
    }
    ...
    private ColumnarBatchReadStore(final ColumnarBatchReadStoreBuilder builder) {
        ...
        m_wrappedStore =
            new WrappedBatchReadStore(m_readable, builder.m_readStore.numBatches(), builder.m_readStore.batchLength());
    }
