...
final class UpdatedColumnarValueSchema implements ColumnarValueSchema {
    ...
    @Override
    public <C extends ColumnReadData> ColumnarReadValueFactory<C> getReadValueFactoryAt(final int colIndex) {
        return m_delegate.getReadValueFactoryAt(colIndex);
    }

    @Override
    public <C extends ColumnWriteData> ColumnarWriteValueFactory<C> getWriteValueFactoryAt(final int colIndex) {
        return m_delegate.getWriteValueFactoryAt(colIndex);
    }
    ...
    public RowKeyType getRowKeyType() {
        return m_delegate.getRowKeyType();
    }
}
