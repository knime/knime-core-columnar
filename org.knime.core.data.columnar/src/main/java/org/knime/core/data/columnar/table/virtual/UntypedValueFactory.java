 ...
 */
final class UntypedValueFactory {
    private final ValueFactory<?, ?> m_valueFactory;

    UntypedValueFactory(final ValueFactory<?, ?> valueFactory) {
    ...
    void initFsHandler(final IWriteFileStoreHandler fsHandler) {
        ValueFactoryUtils.initializeForWriting(m_valueFactory, fsHandler);
    }
    ...
    NullableWriteValue createNullableWriteValue(final WriteAccess access) {
        return new NullableWriteValue(createWriteValue(access), access);
    }

    NullableReadValue createNullableReadValue(final ReadAccess access) {
        return new NullableReadValue(createReadValue(access), access);
    }
