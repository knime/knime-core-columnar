...
public final class ColumnarRowContainerUtils {
    ...
    public static RowContainer create(final ExecutionContext context, final int tableId,
        final DataTableValueSchema schema, final ColumnarRowWriteTableSettings settings) throws Exception {
    ...
    public static DataContainerDelegate create(final int tableId, final DataTableValueSchema schema,
