...
import org.knime.core.columnar.arrow.offheap.data.OffHeapArrowIntData.ArrowIntReadData;
import org.knime.core.columnar.arrow.offheap.data.OffHeapArrowIntData.ArrowIntWriteData;
...
/**
 * Test {@link OffHeapArrowStructData} with a struct consisting of a string, integer, and struct (of varbinary and double).
 *
 * @author Benjamin Wilhelm, KNIME GmbH, Konstanz, Germany
 */
public class OffHeapArrowComplexStructDataTest extends AbstractOffHeapArrowDataTest<ArrowStructWriteData, ArrowStructReadData> {
    ...
    /** Create the test for {@link OffHeapArrowStructData} */
    public OffHeapArrowComplexStructDataTest() {
        super(createFactory());
    }
