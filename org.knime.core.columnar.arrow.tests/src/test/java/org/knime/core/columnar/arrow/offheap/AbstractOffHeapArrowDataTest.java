 ...
 */
public abstract class AbstractOffHeapArrowDataTest<W extends OffHeapArrowWriteData, R extends OffHeapArrowReadData> {
    ...
    protected final OffHeapArrowColumnDataFactory m_factory;
     ...
     */
    protected AbstractOffHeapArrowDataTest(final OffHeapArrowColumnDataFactory factory) {
        m_factory = factory;
    }
     ...
     * {@link #setValue(OffHeapArrowWriteData, int, int)}.
     *
     * @param data the data object
     * @param index the index
     * @param seed the seed
    ...
    protected W createWrite(final int numValues) {
        return castW(OffHeapArrowColumnDataFactory.createWrite(m_factory, "0", m_alloc, numValues));
    }
    ...
    public void testWriteRead() throws IOException {
        ...
        try (final OffHeapArrowBatchReader reader =
            new OffHeapArrowBatchReader(tmp.asFile(), m_alloc, factories, new DefaultColumnSelection(1))) {
    ...
    /**
     * Test that {@link OffHeapArrowColumnDataFactory#initialNumBytesPerElement()} returns a reasonable estimate for the
     * allocated size.
     */
    @Test
