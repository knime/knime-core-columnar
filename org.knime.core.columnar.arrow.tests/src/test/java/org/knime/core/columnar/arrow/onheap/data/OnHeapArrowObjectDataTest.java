 ...
 */
public class OnHeapArrowObjectDataTest extends AbstractOnHeapArrowDataTest<ArrowVarBinaryWriteData, ArrowVarBinaryReadData> {

    private static final int MAX_LENGTH = 100;

    /** Create the test for {@link ArrowVarBinaryData} */
    public OnHeapArrowObjectDataTest() {
