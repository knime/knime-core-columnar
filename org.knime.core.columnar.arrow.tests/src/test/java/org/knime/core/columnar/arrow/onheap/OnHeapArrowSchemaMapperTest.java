...
import org.knime.core.columnar.arrow.onheap.data.ArrowDictEncodedStringData.ArrowDictEncodedStringDataFactory;
import org.knime.core.columnar.arrow.onheap.data.ArrowDictEncodedVarBinaryData.ArrowDictEncodedVarBinaryDataFactory;
...
import org.knime.core.columnar.arrow.onheap.data.ArrowListData.ArrowListDataFactory;
import org.knime.core.columnar.arrow.onheap.data.ArrowLongData.ArrowLongDataFactory;
import org.knime.core.columnar.arrow.onheap.data.ArrowSmartStringData.ArrowStringDataFactory;
import org.knime.core.columnar.arrow.onheap.data.ArrowStructData.ArrowStructDataFactory;
import org.knime.core.columnar.arrow.onheap.data.ArrowVarBinaryData.ArrowVarBinaryDataFactory;
import org.knime.core.columnar.arrow.onheap.data.ArrowVoidData.ArrowVoidDataFactory;
 ...
 */
public class OnHeapArrowSchemaMapperTest {
    ...
    public void testWrapEmptyTraits() {
        ...
        assertEquals(factory, OnHeapArrowSchemaMapper.wrap(factory, DefaultDataTraits.EMPTY));
        ...
        assertEquals(nestedFactory, OnHeapArrowSchemaMapper.wrap(nestedFactory, nestedTraits));
        ...
        assertEquals(listFactory, OnHeapArrowSchemaMapper.wrap(listFactory, listTraits));
    }
    ...
    public void testWrapTraits() {
        ...
        assertEquals(new ExtensionArrowColumnDataFactory(new ArrowStructDataFactory(factory), nestedTraits),
            OnHeapArrowSchemaMapper.wrap(nestedFactory, nestedTraits));
        ...
        assertEquals(new ExtensionArrowColumnDataFactory(new ArrowListDataFactory(factory), listTraits),
            OnHeapArrowSchemaMapper.wrap(listFactory, listTraits));
    }
    ...
    private static OnHeapArrowColumnDataFactory unwrap(final OnHeapArrowColumnDataFactory factory) {
    ...
    private static void testMapSingleSpec(final DataSpec spec, final OnHeapArrowColumnDataFactory expectedFactory) {
    ...
    private static void testMapSchema(final ColumnarSchema schema, final OnHeapArrowColumnDataFactory expectedFactory) {
        final OnHeapArrowColumnDataFactory[] factories = OnHeapArrowSchemaMapper.map(schema);
