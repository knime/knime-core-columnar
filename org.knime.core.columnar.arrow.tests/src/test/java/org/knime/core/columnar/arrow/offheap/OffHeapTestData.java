 ...
 */
public final class OffHeapTestData {

    private OffHeapTestData() {
    }
     ...
     * instances.
     */
    public static final class SimpleData implements OffHeapArrowWriteData, OffHeapArrowReadData {
     ...
     */
    public static final class DictionaryEncodedData implements OffHeapArrowReadData, OffHeapArrowWriteData {
     ...
     */
    public static final class ComplexData implements OffHeapArrowReadData, OffHeapArrowWriteData {
