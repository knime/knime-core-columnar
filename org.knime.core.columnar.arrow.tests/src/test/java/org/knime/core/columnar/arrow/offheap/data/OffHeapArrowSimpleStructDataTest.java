...
/**
 * Test {@link OffHeapArrowStructData} with a struct consisting of a double and an integer.
 *
 * @author Benjamin Wilhelm, KNIME GmbH, Konstanz, Germany
 */
public class OffHeapArrowSimpleStructDataTest extends AbstractOffHeapArrowDataTest<ArrowStructWriteData, ArrowStructReadData> {

    /** Create the test for {@link OffHeapArrowStructData} */
    public OffHeapArrowSimpleStructDataTest() {
