...
public class Lz4BlockCompressionLegacyTest {
    ...
    private static void writeBatch(final ArrowBatchWriter writer, final int seed) throws IOException {
    ...
    private static void checkBatch(final ArrowBatchReader reader, final int index) throws IOException {
