...
public class ArrowLongDataTest extends AbstractArrowDataTest<ArrowLongData, ArrowLongData> {
    ...
    @Override
    protected void setValue(final ArrowLongData data, final int index, final int seed) {
        data.setLong(index, valueFor(seed));
    }

    @Override
    protected void checkValue(final ArrowLongData data, final int index, final int seed) {
