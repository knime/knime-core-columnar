 ...
 */
public class OnHeapArrowSmartStringDataTest extends AbstractOnHeapArrowDataTest<ArrowStringWriteData, ArrowStringReadData> {
    ...
    public OnHeapArrowSmartStringDataTest() {
