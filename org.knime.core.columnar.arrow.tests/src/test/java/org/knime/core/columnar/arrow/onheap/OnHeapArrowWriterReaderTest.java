...
import org.knime.core.columnar.arrow.onheap.OnHeapTestData.ComplexData;
import org.knime.core.columnar.arrow.onheap.OnHeapTestData.ComplexDataFactory;
import org.knime.core.columnar.arrow.onheap.OnHeapTestData.DictionaryEncodedData;
import org.knime.core.columnar.arrow.onheap.OnHeapTestData.DictionaryEncodedDataFactory;
import org.knime.core.columnar.arrow.onheap.OnHeapTestData.SimpleData;
import org.knime.core.columnar.arrow.onheap.OnHeapTestData.SimpleDataFactory;
 ...
 */
public class OnHeapArrowWriterReaderTest {
    ...
    public void testSimpleReadWriteOneBatchOneColumn() throws IOException {
        final OnHeapArrowColumnDataFactory[] factories = new OnHeapArrowColumnDataFactory[]{new SimpleDataFactory()};
    ...
    public void testSimpleReadWriteOneBatchTenColumn() throws IOException {
        ...
        final OnHeapArrowColumnDataFactory[] factories = IntStream.range(0, numColumns).mapToObj(i -> new SimpleDataFactory())
    ...
    public void testDictionaryReadWriteOneBatchOneColumn() throws IOException {
        final OnHeapArrowColumnDataFactory[] factory = new OnHeapArrowColumnDataFactory[]{new DictionaryEncodedDataFactory()};
    ...
    public void testDictionaryReadWriteOneBatchTenColumn() throws IOException {
        final int numColumns = 10;
        final OnHeapArrowColumnDataFactory[] factories = IntStream.range(0, numColumns)
            .mapToObj(i -> new DictionaryEncodedDataFactory()).toArray(OnHeapArrowColumnDataFactory[]::new);
    ...
    public void testComplexReadWriteOneBatchOneColumn() throws IOException {
        final OnHeapArrowColumnDataFactory[] factories = new OnHeapArrowColumnDataFactory[]{new ComplexDataFactory()};
    ...
    public void testComplexReadWriteOneBatchTenColumn() throws IOException {
        final int numColumns = 10;
        final OnHeapArrowColumnDataFactory[] factories = IntStream.range(0, numColumns)
            .mapToObj(i -> new ComplexDataFactory()).toArray(OnHeapArrowColumnDataFactory[]::new);
    ...
    public void testSimpleShortChunkReadWrite() throws IOException {
        ...
        try (final OnHeapArrowBatchReader reader =
            new OnHeapArrowBatchReader(m_path.asFile(), m_alloc, factories, new DefaultColumnSelection(1))) {
    ...
    public void testSimpleRandomAccessRead() throws IOException {
        ...
        try (final OnHeapArrowBatchReader reader =
            new OnHeapArrowBatchReader(m_path.asFile(), m_alloc, factories, new DefaultColumnSelection(numColumns))) {
            final int b = 7;
    ...
    public void testFilteredRead() throws IOException {
        ...
        final int capacity = 32;
        final int dataCount = 32;
        final OnHeapArrowColumnDataFactory[] factories =
            new OnHeapArrowColumnDataFactory[]{new SimpleDataFactory(), new SimpleDataFactory(), new ComplexDataFactory(),
        ...
        try (final OnHeapArrowBatchReader reader =
            new OnHeapArrowBatchReader(m_path.asFile(), m_alloc, factories, new FilteredColumnSelection(numColumns, 0, 2))) {
    ...
    public void testFactoryVersionReadWrite() throws IOException {
        final OnHeapArrowColumnDataFactory[] factories =
            new OnHeapArrowColumnDataFactory[]{new SimpleDataFactory(ArrowColumnDataFactoryVersion.version(15))};
        testReadWrite(64, 64, 1, 1, factories, new SimpleDataChecker(false), ARROW_NO_COMPRESSION);
    }
    ...
    public void testFactoryComplexVersionReadWrite() throws IOException {
        final OnHeapArrowColumnDataFactory[] factories =
            new OnHeapArrowColumnDataFactory[]{new SimpleDataFactory(ArrowColumnDataFactoryVersion.version(1,
    ...
    public void testReadBatchBoundariesAfterWrite() throws IOException {
        ...
        try (var store = new OnHeapArrowBatchReadStore(m_path.asPath(), m_alloc)) {
    ...
    private void testReadWrite(final int capacity, final int dataCount, final int numColumns, final int numBatches,
        final OnHeapArrowColumnDataFactory[] factories, final DataChecker dataChecker, final ArrowCompression compression)
        throws IOException {
    ...
    private static final <T extends NullableWriteData> T createWrite(final OnHeapArrowColumnDataFactory factory,
        final int numValues) {
    ...
    private static final class SimpleDataChecker implements DataChecker {
        ...
        public NullableReadData fillData(final NullableWriteData data, final int columnIndex, final int count,
            ...
            return OnHeapTestData.fillData((SimpleData)data, m_checkMissing, count, seed);
        }

        @Override
        public void checkData(final NullableReadData data, final int columnIndex, final int count, final long seed) {
            assertTrue(data instanceof SimpleData);
            OnHeapTestData.checkData((SimpleData)data, m_checkMissing, count, seed);
        }
    }
    ...
    private static final class DictionaryEncodedDataChecker implements DataChecker {
        ...
        public NullableReadData fillData(final NullableWriteData data, final int columnIndex, final int count,
            ...
            return OnHeapTestData.fillData((DictionaryEncodedData)data, count, seed);
        }

        @Override
        public void checkData(final NullableReadData data, final int columnIndex, final int count, final long seed) {
            assertTrue(data instanceof DictionaryEncodedData);
            OnHeapTestData.checkData((DictionaryEncodedData)data, count, seed);
        }
    }
    ...
    private static final class ComplexDataChecker implements DataChecker {
        ...
        public NullableReadData fillData(final NullableWriteData data, final int coulumnIndex, final int count,
            ...
            return OnHeapTestData.fillData((ComplexData)data, count, seed);
        }

        @Override
        public void checkData(final NullableReadData data, final int columnIndex, final int count, final long seed) {
            assertTrue(data instanceof ComplexData);
            OnHeapTestData.checkData((ComplexData)data, count, seed);
        }
    }
}
