...
/**
 * Test {@link OffHeapArrowVarBinaryData} with the setObject and getObject methods
 *
 * @author Christian Dietz, KNIME GmbH, Konstanz, Germany
 * @author Benjamin Wilhelm, KNIME GmbH, Konstanz, Germany
 */
public class OffHeapArrowObjectDataTest extends AbstractOffHeapArrowDataTest<ArrowVarBinaryWriteData, ArrowVarBinaryReadData> {

    private static final int MAX_LENGTH = 100;

    /** Create the test for {@link OffHeapArrowVarBinaryData} */
    public OffHeapArrowObjectDataTest() {
