...
public class OffHeapStructDictEncodingTest {
    ...
    public void testSimpleDictCreation() {
        ...
        final var data = (ArrowDictEncodedStringWriteData<Long>)OffHeapArrowColumnDataFactory.createWrite(factory, "0",
            m_alloc, numRows);
    ...
    public void testRandomAccessRead() {
        ...
        @SuppressWarnings("unchecked")
        final var data = (ArrowDictEncodedStringWriteData<Byte>)OffHeapArrowColumnDataFactory.createWrite(factory, "0",
            m_alloc, numRows);
