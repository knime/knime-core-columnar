...
public class Lz4BlockCompressionLegacyTest {
    ...
    public void testReadLz4BlockData() throws IOException {
        ...
        try (final OffHeapArrowBatchReader reader =
            new OffHeapArrowBatchReader(FILE.asFile(), m_alloc, factories, new DefaultColumnSelection(2))) {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        try (final RootAllocator alloc = new RootAllocator(); //
                ...
                final OffHeapArrowBatchWriter writer =
                    new OffHeapArrowBatchWriter(FILE, factories, ARROW_LZ4_BLOCK_COMPRESSION, alloc)) {
            for (int b = 0; b < NUM_BATCHES; b++) {
                writeBatch(writer, b);
            }
        }
    ...
    private static void writeBatch(final OffHeapArrowBatchWriter writer, final int seed) throws IOException {
    ...
    private static void checkBatch(final OffHeapArrowBatchReader reader, final int index) throws IOException {
