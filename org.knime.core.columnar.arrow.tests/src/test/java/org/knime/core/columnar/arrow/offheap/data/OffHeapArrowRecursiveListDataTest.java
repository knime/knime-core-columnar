...
/**
 * Test {@link OffHeapArrowListData} with a recursive lists.
 *
 * @author Benjamin Wilhelm, KNIME GmbH, Konstanz, Germany
 */
public class OffHeapArrowRecursiveListDataTest extends AbstractOffHeapArrowDataTest<ArrowListWriteData, ArrowListReadData> {
    ...
    public OffHeapArrowRecursiveListDataTest() {
        super(createFactory());
    }
