...
import org.knime.core.columnar.arrow.offheap.data.OffHeapArrowLegacyDictionaryUtils;
...
class OffHeapTestArrowBatchWriter extends OffHeapArrowBatchWriter {
    ...
    OffHeapTestArrowBatchWriter(final FileHandle file, final OffHeapArrowColumnDataFactory[] factories,
        ...
        this.m_usesDictionaries = OffHeapArrowLegacyDictionaryUtils.usesDictionaries(factories);
    }
    ...
    protected List<FieldVector> getDictionaries(final ReadBatch batch) {
        ...
        for (int i = 0; i < m_factories.length; i++) {
            ...
            final DictionaryProvider dictionaries = OffHeapArrowLegacyDictionaryUtils.getDictionaries(factory, data);
