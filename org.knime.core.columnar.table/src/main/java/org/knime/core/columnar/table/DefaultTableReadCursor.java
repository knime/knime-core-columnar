...
final class DefaultTableReadCursor implements TableReadCursor {
    ...
    DefaultTableReadCursor(final ColumnDataReader reader, final TableSchema schema) {
        m_reader = reader;
    ...
    private ColumnDataAccess<ColumnData>[] createAccess(final TableSchema schema) {
        @SuppressWarnings("unchecked")
