...
public final class ColumnarTableUtils {
    ...
    public static ColumnStoreReadTable createReadTable(final TableSchema schema, final ColumnReadStore store) {
        return new ColumnStoreReadTable(schema, store);
    }

    // TODO check compatibility of schema
    public static ColumnStoreWriteTable createWriteTable(final TableSchema schema, final ColumnStore store) {
