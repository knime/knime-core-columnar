...
public class ColumnStoreWriteTable implements WriteTable {
    ...
    ColumnStoreWriteTable(final TableSchema schema, final ColumnStore store) {
        m_store = store;
        m_schema = schema;
    }
    ...
    private static ColumnDataAccess<ColumnData>[] createAccess(final TableSchema schema) {
