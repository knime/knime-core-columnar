...
public class ArrowDataBenchmark {
    ...
    public void readAndUseFromDisk(final BenchmarkStateWritten state, final Blackhole bh) throws IOException {
        state.dataSet.useData(state.reader, state.batchStore.numBatches(), bh);
    }
    ...
    interface DataUser {
        void useData(final RandomAccessBatchReader reader, final int numBatches, final Blackhole bh) throws IOException;
    }
    ...
    public static enum DataSets implements DataFiller, DataUser {
        ...
        @Override
        public void useData(final RandomAccessBatchReader reader, final int numBatches, final Blackhole bh)
            throws IOException {
