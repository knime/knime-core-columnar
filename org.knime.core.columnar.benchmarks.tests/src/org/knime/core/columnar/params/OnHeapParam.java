...
/**
 * Enumeration of the off-heap or on-heap Arrow implementations that can be used during benchmarks.
 *
 * @author Benjamin Wilhelm, KNIME GmbH, Berlin, Germany
 */
public enum OnHeapParam {
    ...
    /** Applies the value of the parameter */
    public void apply() {
