...
import org.knime.core.columnar.access.ColumnarVoidAccessFactory.VoidReadAccess;
import org.knime.core.columnar.access.ColumnarVoidAccessFactory.VoidWriteAccess;
...
public class ColumnarVoidAccessFactoryTest {
    ...
    public void testAccesses() {
        ...
        final VoidDataSpec spec = VoidDataSpec.INSTANCE;
        ...
        final VoidWriteAccess writeAccess = factory.createWriteAccess(() -> 0);
        writeAccess.setData(data);
        final VoidReadAccess readAccess = factory.createReadAccess(() -> 0);
