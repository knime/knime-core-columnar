...
public final class ArrowLongData {
    ...
    public static final class ArrowLongReadData extends AbstractArrowReadData implements LongReadData {
        ...
        public ArrowLongReadData(final long[] data, final ValidityBuffer validity) {
            super(validity, data.length);
            m_data = data;
        }

        public ArrowLongReadData(final long[] data, final ValidityBuffer validity, final int offset,
            final int length) {
