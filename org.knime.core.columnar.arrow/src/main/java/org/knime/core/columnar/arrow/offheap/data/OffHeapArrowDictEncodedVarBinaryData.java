...
import org.knime.core.columnar.arrow.offheap.data.AbstractOffHeapArrowDictEncodedData.AbstractArrowDictEncodedDataFactory;
import org.knime.core.columnar.arrow.offheap.data.AbstractOffHeapArrowDictEncodedData.AbstractArrowDictEncodedReadData;
import org.knime.core.columnar.arrow.offheap.data.AbstractOffHeapArrowDictEncodedData.AbstractArrowDictEncodedWriteData;
 ...
 */
public final class OffHeapArrowDictEncodedVarBinaryData {
    private OffHeapArrowDictEncodedVarBinaryData() {
    }
    ...
    public static final class ArrowDictEncodedVarBinaryWriteData<K> extends AbstractArrowDictEncodedWriteData<Object, K>
        ...
        public <T> void setObject(final int index, final T val, final ObjectSerializer<T> serializer) {
            K dictKey = m_dict.computeIfAbsent(val, v -> {//NOSONAR
                ((VarBinaryWriteData)m_delegate.getWriteDataAt(AbstractOffHeapArrowDictEncodedData.DICT_ENTRY_DATA_INDEX))
    ...
    public static final class ArrowDictEncodedVarBinaryReadData<K> extends AbstractArrowDictEncodedReadData<Object, K>
        ...
        public <T> T getObject(final int index, final ObjectDeserializer<T> deserializer) {
            ...
            return (T)m_dict.computeIfAbsent(dictKey,
                i -> ((VarBinaryReadData)m_delegate.getReadDataAt(AbstractOffHeapArrowDictEncodedData.DICT_ENTRY_DATA_INDEX))
    ...
    /**
     * Implementation of {@link OffHeapArrowColumnDataFactory} for {@link OffHeapArrowDictEncodedVarBinaryData}.
     *
     * @author Carsten Haubold, KNIME GmbH, Konstanz, Germany
     */
