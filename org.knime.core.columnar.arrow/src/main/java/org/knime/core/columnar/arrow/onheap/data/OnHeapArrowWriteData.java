 ...
 */
public interface OnHeapArrowWriteData extends NullableWriteData {
     ...
     */
    OnHeapArrowWriteData slice(int start);

    /**
     * {@inheritDoc}
     *
     * Note: The returned {@link OnHeapArrowReadData} is not sliced.
     */
    @Override
    OnHeapArrowReadData close(int length);
}
