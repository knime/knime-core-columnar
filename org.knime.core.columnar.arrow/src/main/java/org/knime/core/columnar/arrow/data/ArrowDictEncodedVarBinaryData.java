...
public final class ArrowDictEncodedVarBinaryData {
     ...
     * @author Carsten Haubold, KNIME GmbH, Konstanz, Germany
     */
    public static final class ArrowDictEncodedVarBinaryWriteData<K>
        extends AbstractArrowDictEncodedWriteData<Object, K> implements DictEncodedVarBinaryWriteData<K> {
