...
public final class ArrowStringData {
    ...
    public static final class ArrowStringReadData extends AbstractArrowReadData implements StringReadData {
        ...
        public ArrowStringReadData(final String[] data, final ValidityBuffer validity) {
            super(validity, data.length);
            m_data = data;
        }

        public ArrowStringReadData(final String[] data, final ValidityBuffer validity, final int offset,
            final int length) {
