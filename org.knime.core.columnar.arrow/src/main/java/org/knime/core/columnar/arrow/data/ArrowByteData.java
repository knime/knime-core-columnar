...
public final class ArrowByteData {
    ...
    public static final class ArrowByteReadData extends AbstractArrowReadData implements ByteReadData {
        ...
        public ArrowByteReadData(final byte[] data, final ValidityBuffer validity) {
            super(validity, data.length);
            m_data = data;
        }

        public ArrowByteReadData(final byte[] data, final ValidityBuffer validity, final int offset,
            final int length) {
