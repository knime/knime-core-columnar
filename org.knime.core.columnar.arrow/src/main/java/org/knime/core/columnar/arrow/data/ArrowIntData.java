...
public final class ArrowIntData {
    ...
    public static final class ArrowIntReadData extends AbstractArrowReadData implements IntReadData {
        ...
        public ArrowIntReadData(final int[] data, final ValidityBuffer validity) {
            super(validity, data.length);
            m_data = data;
        }

        public ArrowIntReadData(final int[] data, final ValidityBuffer validity, final int offset, final int length) {
