 ...
 */
class OffHeapArrowSimpleBatchWriter implements BatchWriter {

    private static final Logger LOGGER = LoggerFactory.getLogger(OffHeapArrowSimpleBatchWriter.class);
     ...
     *            their index.
     */
    OffHeapArrowSimpleBatchWriter(final FileHandle file, final OffHeapArrowColumnDataFactory[] factories,
    ...
    public WriteBatch create(final int capacity) {
        ...
        for (int i = 0; i < m_factories.length; i++) {
            ...
            chunk[i] = OffHeapArrowColumnDataFactory.createWrite(m_factories[i], String.valueOf(i), m_allocator, capacity);
        }
