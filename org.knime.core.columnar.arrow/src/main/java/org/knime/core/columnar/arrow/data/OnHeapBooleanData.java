...
public final class OnHeapBooleanData {
    ...
    public static final class OnHeapBooleanWriteData extends AbstractArrowWriteData implements BooleanWriteData {
        ...
        private OnHeapBooleanWriteData(final int capacity) {
            super(capacity);
            m_data = new ValidityBuffer(capacity);
            m_capacity = capacity;
        }

        private OnHeapBooleanWriteData(final int offset, final ValidityBuffer data, final ValidityBuffer validity,
            final int capacity) {
        ...
        public ArrowWriteData slice(final int start) {
            return new OnHeapBooleanWriteData(m_offset + start, m_data, m_validity, m_capacity);
        }
        ...
        @Override
        public OnHeapBooleanReadData close(final int length) {
            setNumElements(length);
            return new OnHeapBooleanReadData(m_data, m_validity, length);
        }
    ...
    public static final class OnHeapBooleanReadData extends AbstractArrowReadData implements BooleanReadData {

        private final ValidityBuffer m_data;

        public OnHeapBooleanReadData(final ValidityBuffer data, final ValidityBuffer validity, final int length) {
            super(validity, length);
            m_data = data;
        }

        public OnHeapBooleanReadData(final ValidityBuffer data, final ValidityBuffer validity, final int offset,
            final int length) {
        ...
        public ArrowReadData slice(final int start, final int length) {
            return new OnHeapBooleanReadData(m_data, m_validity, m_offset + start, length);
        }
    ...
    public static final class OnHeapBooleanDataFactory extends AbstractArrowColumnDataFactory {
        ...
        @Override
        public OnHeapBooleanReadData createRead(final FieldVector vector, final ArrowVectorNullCount nullCount,
            ...
            if (m_version.equals(version)) {
                ...
                return new OnHeapBooleanReadData(data, validity, valueCount);
            } else {
        ...
        @Override
        public OnHeapBooleanWriteData createWrite(final int capacity) {
            return new OnHeapBooleanWriteData(capacity);
        }
        ...
        public void copyToVector(final NullableReadData data, final FieldVector fieldVector) {
            var d = (OnHeapBooleanReadData)data; // TODO generic?
