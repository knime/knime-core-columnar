...
/**
 * Abstract implementation of {@link OffHeapArrowWriteData}. Holds a {@link FieldVector} of type F in {@link #m_vector} and an
...
abstract class AbstractOffHeapArrowWriteData<F extends FieldVector> extends AbstractReferencedData implements OffHeapArrowWriteData {
    ...
    /**
     * Create an abstract {@link OffHeapArrowWriteData} with the given vector and an offset of 0.
     *
     * @param vector the vector
     */
    public AbstractOffHeapArrowWriteData(final F vector) {
        m_vector = vector;
        m_offset = 0;
    }

    /**
     * Create an abstract {@link OffHeapArrowWriteData} with the given vector and offset.
     *
     * @param vector the vector
     * @param offset the offset
     */
    public AbstractOffHeapArrowWriteData(final F vector, final int offset) {
        m_vector = vector;
        m_offset = offset;
    }
    ...
    protected F closeWithLength(final int length) {
        assert m_offset == 0 : "Trying to close a AbstractOffHeapArrowWriteData with m_offset != 0";
