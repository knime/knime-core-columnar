...
import org.knime.core.columnar.arrow.offheap.OffHeapArrowColumnDataFactory.ArrowVectorNullCount;
 ...
 */
abstract class AbstractOffHeapArrowBatchReader {
    ...
    AbstractOffHeapArrowBatchReader(final BufferAllocator allocator, final OffHeapArrowColumnDataFactory[] factories,
