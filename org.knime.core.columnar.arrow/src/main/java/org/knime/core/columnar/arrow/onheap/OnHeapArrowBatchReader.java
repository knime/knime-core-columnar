 ...
 */
class OnHeapArrowBatchReader extends AbstractOnHeapArrowBatchReader implements RandomAccessBatchReader {

    private final File m_file;

    OnHeapArrowBatchReader(final File file, final BufferAllocator allocator, final OnHeapArrowColumnDataFactory[] factories,
