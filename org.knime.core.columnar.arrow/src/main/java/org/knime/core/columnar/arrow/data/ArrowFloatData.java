...
public final class ArrowFloatData {
    ...
    public static final class ArrowFloatReadData extends AbstractArrowReadData implements FloatReadData {
        ...
        public ArrowFloatReadData(final float[] data, final ValidityBuffer validity) {
            super(validity, data.length);
            m_data = data;
        }

        public ArrowFloatReadData(final float[] data, final ValidityBuffer validity, final int offset,
            final int length) {
