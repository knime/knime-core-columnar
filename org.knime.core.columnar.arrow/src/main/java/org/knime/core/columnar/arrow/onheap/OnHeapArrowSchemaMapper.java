...
/**
 * Utility class to map a {@link ColumnarSchema} to an array of {@link OnHeapArrowColumnDataFactory}. The factories can be
...
final class OnHeapArrowSchemaMapper implements MapperWithTraits<OnHeapArrowColumnDataFactory> {
    ...
    /**
     * Map each column of the {@link ColumnarSchema} to the according {@link OnHeapArrowColumnDataFactory}. The factory can be
    ...
    /**
     * Map a single {@link DataSpec} to the according {@link OnHeapArrowColumnDataFactory}. The factory can be used to create,
    ...
    public OnHeapArrowColumnDataFactory visit(final ListDataSpec listDataSpec, final ListDataTraits traits) {
        final OnHeapArrowColumnDataFactory inner = OnHeapArrowSchemaMapper.map(listDataSpec.getInner(), traits.getInner());
