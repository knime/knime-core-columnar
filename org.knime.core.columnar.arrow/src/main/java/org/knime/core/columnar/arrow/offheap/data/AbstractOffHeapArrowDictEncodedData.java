...
import org.knime.core.columnar.arrow.offheap.data.OffHeapArrowStructData.ArrowStructWriteData;
import org.knime.core.columnar.arrow.offheap.data.OffHeapArrowUnsignedByteData.ArrowUnsignedByteDataFactory;
import org.knime.core.columnar.arrow.offheap.data.OffHeapArrowUnsignedIntData.ArrowUnsignedIntDataFactory;
import org.knime.core.columnar.arrow.offheap.data.OffHeapArrowUnsignedLongData.ArrowUnsignedLongDataFactory;
 ...
 */
public final class AbstractOffHeapArrowDictEncodedData {
    private AbstractOffHeapArrowDictEncodedData() {
    }
    ...
    abstract static class AbstractArrowDictEncodedWriteData<T, K> implements DictEncodedWriteData<K>, OffHeapArrowWriteData {
    ...
    abstract static class AbstractArrowDictEncodedReadData<T, K> implements DictEncodedReadData<K>, OffHeapArrowReadData {
    ...
    /**
     * Base implementation for dict encoded {@link OffHeapArrowColumnDataFactory}.
     *
     * @author Carsten Haubold, KNIME GmbH, Konstanz, Germany
     */
    abstract static class AbstractArrowDictEncodedDataFactory implements OffHeapArrowColumnDataFactory {
        ...
        protected AbstractArrowDictEncodedDataFactory(final DataTraits traits,
            final OffHeapArrowColumnDataFactory valueFactory, final int version) {
