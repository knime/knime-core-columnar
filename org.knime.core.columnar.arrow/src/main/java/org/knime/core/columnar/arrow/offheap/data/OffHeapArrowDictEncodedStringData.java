 ...
 */
public final class OffHeapArrowDictEncodedStringData {
    private OffHeapArrowDictEncodedStringData() {
    }
    ...
    public static final class ArrowDictEncodedStringWriteData<K> extends AbstractArrowDictEncodedWriteData<String, K>
        ...
        public void setString(final int index, final String val) {
            K dictKey = m_dict.computeIfAbsent(val, v -> {
                ((StringWriteData)m_delegate.getWriteDataAt(AbstractOffHeapArrowDictEncodedData.DICT_ENTRY_DATA_INDEX))
    ...
    public static final class ArrowDictEncodedStringReadData<K> extends AbstractArrowDictEncodedReadData<String, K>
        ...
        public String getString(final int index) {
            ...
            return m_dict.computeIfAbsent(dictIndex,
                i -> ((StringReadData)m_delegate.getReadDataAt(AbstractOffHeapArrowDictEncodedData.DICT_ENTRY_DATA_INDEX))
    ...
    /**
     * Implementation of {@link OffHeapArrowColumnDataFactory} for {@link OffHeapArrowDictEncodedStringData}
     *
     * @author Carsten Haubold, KNIME GmbH, Konstanz, Germany
     */
