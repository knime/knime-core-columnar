 ...
 */
public final class OffHeapArrowLongData {

    private OffHeapArrowLongData() {
    }

    /** Arrow implementation of {@link LongWriteData}. */
    public static final class ArrowLongWriteData extends AbstractOffHeapArrowWriteData<BigIntVector> implements LongWriteData {
     ...
     */
    static final class ArrowDurationLongReadData extends AbstractOffHeapArrowReadData<DurationVector> implements LongReadData {
     ...
     * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
     */
    static final class ArrowTimeNanoLongReadData extends AbstractOffHeapArrowReadData<TimeNanoVector> implements LongReadData {
    ...
    public static final class ArrowLongReadData extends AbstractOffHeapArrowReadData<BigIntVector> implements LongReadData {
    ...
    /** Implementation of {@link OffHeapArrowColumnDataFactory} for {@link OffHeapArrowLongData} */
    public static final class ArrowLongDataFactory extends AbstractOffHeapArrowColumnDataFactory {
        ...
        @Override
        public ArrowLongWriteData createWrite(final FieldVector vector, final int capacity) {
