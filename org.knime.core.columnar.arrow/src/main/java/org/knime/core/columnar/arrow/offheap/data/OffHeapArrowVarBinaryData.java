 ...
 */
public final class OffHeapArrowVarBinaryData {
    ...
    private OffHeapArrowVarBinaryData() {
    }

    /** Arrow implementation of {@link VarBinaryWriteData}. */
    public static final class ArrowVarBinaryWriteData extends AbstractOffHeapArrowWriteData<LargeVarBinaryVector>
    ...
    public static final class ArrowVarBinaryReadData extends AbstractOffHeapArrowReadData<LargeVarBinaryVector>
     ...
     */
    static final class ArrowDictEncodedLegacyDateTimeVarBinaryReadData extends AbstractOffHeapArrowReadData<IntVector>
        implements VarBinaryReadData {
        ...
        @Override
        public long sizeOf() {
            return OffHeapArrowSizeUtils.sizeOfFixedWidth(m_vector) + OffHeapArrowSizeUtils.sizeOfVariableWidth(m_dict);
        }
    ...
    /** Implementation of {@link OffHeapArrowColumnDataFactory} for {@link OffHeapArrowVarBinaryData} */
    public static final class ArrowVarBinaryDataFactory extends AbstractOffHeapArrowColumnDataFactory {
        ...
        @Override
        public ArrowVarBinaryWriteData createWrite(final FieldVector vector,
            final int capacity) {
