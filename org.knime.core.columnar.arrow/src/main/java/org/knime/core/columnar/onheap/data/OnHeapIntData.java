 ...
 */
public final class OnHeapIntData extends AbstractReferencedData implements IntReadData, IntWriteData {
    ...
    public OnHeapIntData(final int capacity) {
    ...
    private void setNumElements(final int numElements) {
        ...
        final int[] newData = new int[numElements];
