...
import static org.knime.core.columnar.onheap.ArrowReaderWriterUtils.ARROW_FACTORY_VERSIONS_KEY;
 ...
 */
class OnHeapToArrowBatchWriter implements BatchWriter {

    private static final Logger LOGGER = LoggerFactory.getLogger(OnHeapToArrowBatchWriter.class);
