 ...
 */
final class OffHeapArrowUnsignedLongData {

    private OffHeapArrowUnsignedLongData() {
    }

    /** Arrow implementation of unsigned {@link LongWriteData}. */
    public static final class ArrowUnsignedLongWriteData extends AbstractOffHeapArrowWriteData<UInt8Vector>
    ...
    public static final class ArrowUnsignedLongReadData extends AbstractOffHeapArrowReadData<UInt8Vector>
    ...
    /** Implementation of {@link OffHeapArrowColumnDataFactory} for {@link OffHeapArrowUnsignedLongData} */
    @SuppressWarnings("javadoc")
    public static final class ArrowUnsignedLongDataFactory extends AbstractOffHeapArrowColumnDataFactory {
        ...
        @Override
        public ArrowUnsignedLongWriteData createWrite(final FieldVector vector, final int capacity) {
