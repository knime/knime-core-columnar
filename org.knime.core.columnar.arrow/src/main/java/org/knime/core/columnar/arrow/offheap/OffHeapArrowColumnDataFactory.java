 ...
 */
public interface OffHeapArrowColumnDataFactory {
     ...
     */
    OffHeapArrowReadData createRead(FieldVector vector, ArrowVectorNullCount nullCount, DictionaryProvider provider,
