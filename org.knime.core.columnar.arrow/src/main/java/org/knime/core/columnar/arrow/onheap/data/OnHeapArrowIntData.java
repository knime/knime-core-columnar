...
public final class OnHeapArrowIntData {
    ...
    public static final class ArrowIntWriteData extends AbstractOnHeapArrowWriteData<int[], ArrowIntReadData>
        ...
        @Override
        protected ArrowIntReadData createReadData(final int length) {
