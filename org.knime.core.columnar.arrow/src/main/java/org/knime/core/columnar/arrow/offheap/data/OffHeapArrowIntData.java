 ...
 */
public final class OffHeapArrowIntData {

    private OffHeapArrowIntData() {
    }

    /** Arrow implementation of {@link IntWriteData}. */
    public static final class ArrowIntWriteData extends AbstractOffHeapArrowWriteData<IntVector> implements IntWriteData {
    ...
    public static final class ArrowIntReadData extends AbstractOffHeapArrowReadData<IntVector> implements IntReadData {
    ...
    /** Implementation of {@link OffHeapArrowColumnDataFactory} for {@link OffHeapArrowIntData} */
    public static final class ArrowIntDataFactory extends AbstractOffHeapArrowColumnDataFactory {
        ...
        @Override
        public ArrowIntWriteData createWrite(final FieldVector vector, final int capacity) {
