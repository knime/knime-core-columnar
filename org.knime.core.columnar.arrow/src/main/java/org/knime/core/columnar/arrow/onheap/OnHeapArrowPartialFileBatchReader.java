 ...
 */
class OnHeapArrowPartialFileBatchReader extends AbstractOnHeapArrowBatchReader implements SequentialBatchReader {
    ...
    OnHeapArrowPartialFileBatchReader(final File file, final BufferAllocator allocator,
        final OnHeapArrowColumnDataFactory[] factories, final ColumnSelection columnSelection,
