...
public final class ArrowDoubleData {
    ...
    public static final class ArrowDoubleReadData extends AbstractArrowReadData implements DoubleReadData {
        ...
        public ArrowDoubleReadData(final double[] data, final ValidityBuffer validity) {
            super(validity, data.length);
            m_data = data;
        }

        public ArrowDoubleReadData(final double[] data, final ValidityBuffer validity, final int offset,
            final int length) {
