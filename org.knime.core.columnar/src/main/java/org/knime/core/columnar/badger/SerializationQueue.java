...
interface SerializationQueue extends Closeable {
     ...
     *   thread and will block (only) that thread until all entries queued at the
     ...
     * <p>
     * When {@code finish()} returns, {@link Serializer#serialize} has run on all entries and the queue has been
     * {@link #close() closed}.
     * <p>
