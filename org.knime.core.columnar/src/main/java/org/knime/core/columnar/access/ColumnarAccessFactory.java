...
/**
 * Creates {@link ReadAccess ReadAccesses} and {@link WriteAccess WriteAccesses} based on {@link NullableReadData}
 * objects.
 *
 ...
 * @since 4.3
 */
public interface ColumnarAccessFactory {
     ...
     */
    ColumnarWriteAccess createWriteAccess(ColumnDataIndex index);
