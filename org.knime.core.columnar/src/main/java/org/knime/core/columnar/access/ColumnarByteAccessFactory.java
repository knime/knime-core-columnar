 ...
 */
final class ColumnarByteAccessFactory implements ColumnarAccessFactory {

    public static final ColumnarByteAccessFactory INSTANCE = new ColumnarByteAccessFactory();

    @Override
    public ColumnarByteReadAccess createReadAccess(final ColumnDataIndex index) {
        return new ColumnarByteReadAccess(index);
    }
    ...
    static final class ColumnarByteReadAccess extends AbstractReadAccess<ByteReadData> implements ByteReadAccess {

        ColumnarByteReadAccess(final ColumnDataIndex index) {
            super(index);
        }
    ...
    static final class ColumnarByteWriteAccess extends AbstractWriteAccess<ByteWriteData> implements ByteWriteAccess {
        ...
        ColumnarByteWriteAccess(final ColumnDataIndex index) {
            super(index);
        }

        @Override
        public void setByteValue(final byte value) {
            m_data.setByte(m_index.getIndex(), value);
        }
