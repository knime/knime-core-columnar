...
/**
 * An implementation of {@link BatchWritable} and {@link RandomAccessBatchReadable} for which the following contracts
 * hold:
 * <ol>
 * <li>The singleton {@link BatchWriter writer} can only be {@link #getWriter() obtained} as long as both the store and
 * the writer are unclosed.
 ...
 * reader are unclosed.
 * </ol>
 * Failure to adhere to these contracts results in an IllegalStateException.
 *
 * @author Marc Bux, KNIME GmbH, Berlin, Germany
 * @author Christian Dietz, KNIME GmbH, Konstanz, Germany
 */
public interface BatchStore extends BatchWritable, BatchReadStore {
}
