 ...
 */
public interface SequentialBatchReadable extends BatchReadable {

    /**
     * Creates a new {@link SequentialBatchReader} that reads {@link ReadBatch ReadBatches}, in which columns are
