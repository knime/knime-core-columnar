...
class DefaultSerializationQueue implements SerializationQueue {
    ...
    public void flush() throws InterruptedException, IOException {
        ...
        try {
            debugPrintIndices();
            final long row = m_offset + m_current - 1; // numRows() - 1
    ...
    public void close() throws IOException {
        ...
        try {
            ...
            if (m_interruptSerializerThread != null) {
                ...
                // may not have been called yet, or not have progressed to a
                // point where it could be waiting on anything. We don't need to
                // interrupt it. It will see m_closing == true, close the
                // serializer, and m_closed.signal().
                //
