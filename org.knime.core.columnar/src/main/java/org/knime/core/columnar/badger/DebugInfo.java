...
public class DebugInfo {
    ...
    private final StringBuilder m_messages = new StringBuilder();

    public void stacktrace(final int maxDepth) {
        stacktrace(3, maxDepth);
    }

    public void stacktrace(final int startDepth, final int maxDepth, final String... unlessContains) {
        ...
        for (int i = startDepth; i < len; ++i) {
            ...
            m_messages.append(prefix + trace[i].toString() + "\n");
        }
    }
