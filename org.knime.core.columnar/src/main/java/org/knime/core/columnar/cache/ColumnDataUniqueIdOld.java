 ...
 */
public final class ColumnDataUniqueIdOld {

    private final RandomAccessBatchReadable m_readable;

    private final DataIndexOld m_dataIndex;
     ...
     */
    public ColumnDataUniqueIdOld(final RandomAccessBatchReadable readable, final DataIndexOld dataIndex,
     ...
     * @param batchIndex the batch index of the data
     */
    public ColumnDataUniqueIdOld(final RandomAccessBatchReadable readable, final int columnIndex, final int batchIndex) {
        this(readable, DataIndexOld.createColumnIndex(columnIndex), batchIndex);
    }
    ...
    public boolean equals(final Object object) {
        ...
        if (object instanceof ColumnDataUniqueIdOld)
        {
            final ColumnDataUniqueIdOld other = (ColumnDataUniqueIdOld)object;
     ...
     */
    public ColumnDataUniqueIdOld getChild(final int index) {
        return new ColumnDataUniqueIdOld(m_readable, m_dataIndex.getChild(index), m_batchIndex);
    }
