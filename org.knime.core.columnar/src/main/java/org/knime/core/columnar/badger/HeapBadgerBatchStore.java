...
/**
 * A {@link BatchStore} the wraps a {@link HeapBadger}
 *
 * @author Carsten Haubold, KNIME GmbH, Konstanz, Germany
 */
public class HeapBadgerBatchStore implements BatchStore, BatchingWritable {

    private final HeapBadger m_heapBadger;
     ...
     * @param fileHandle
     */
    public HeapBadgerBatchStore(final HeapBadger heapBadger, final FileHandle fileHandle) {
        m_heapBadger = heapBadger;
    ...
    public ColumnarSchema getSchema() {
        return m_heapBadger.getSchema();
    }

    @Override
    public int numBatches() {
        return m_heapBadger.numBatches();
    }
